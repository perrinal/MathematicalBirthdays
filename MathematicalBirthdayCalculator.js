...
class MathematicalBirthdayCalculator{
    constructor(year, month, day , timezone=null) {
    ...
    getDaysBirthdaysNumbers(precision=1000){
    ...
    getPrimeBirthdaysNumbers(precision=100){
    ...
    getPIBirthdaysNumbers(limit = this._max, precision = 1000){
        var i = 1;
